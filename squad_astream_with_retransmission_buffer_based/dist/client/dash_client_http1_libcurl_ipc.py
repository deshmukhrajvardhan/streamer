...
def print_representations(dp_object):
    ...
    print
    "The DASH media has the following video representations/bitrates"
    ...
    while segment_number < len(dp_list):
        ...
        if segment_number == dp_object.video[bitrate].start:
            ...
            if playback_type.upper() == "BASIC":
                ...
                print
                "---------------current_bitrate: " + str(current_bitrate)
...
def main():
    ...
    if not MPD:
        print
        "ERROR: Please provide the URL to the MPD file. Try Again.."
        return None
