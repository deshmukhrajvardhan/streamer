...
#                        break
                    with open('/mnt/QUIClientServer0/data_read_full_response_http2_hyper','ab') as movie:
                    ...
                    with open('/mnt/QUIClientServer0/chunk_rate_read_full_response_squad_HTTP2.txt', 'a') as chk:
...
def start_playback_smart(dp_object, domain, playback_type=None, download=False, video_segment_duration=None, retrans=False):
    ...
    while segment_number < len(dp_list):
        ...
        segment_download_rate=segment_size/segment_download_time
        with open('/mnt/QUIClientServer0/http2_basic_read_seg_size_rate.txt', 'a') as rate_f:
