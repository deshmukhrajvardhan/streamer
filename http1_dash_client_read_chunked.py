...
#        ssl_context.load_verify_locations(cafile='/mnt/QUIClientServer0/cert.pem')
        ...
        connection = hyper.HTTP11Connection(parse_url.netloc, ssl_context=None, secure=False)
        ...
        with open(segment_filename,'wb') as segment_file_handle:
                for segment_data in seg_conn.read_chunked_give_size(DOWNLOAD_CHUNK):
                    if segment_data is -1:
                        ...
                        with open('/mnt/QUIClientServer0/tst_chunk_rate_read_mod_chunk_squad_hyper_HTTP1.txt','a') as chk:
